...
const API = {
  ...
  getSchemes: (qs) => API.req('/schemes' + (qs ? '?' + qs : ''), { auth: false }),
  classifyMSME: (investment, turnover) => API.req('/schemes/classify', { method: 'POST', auth: false, body: { investment, turnover } }),
  whatsNew: () => API.req('/schemes/whats-new', { auth: false }),
  computeEligibility: (body) => API.req('/schemes/eligibility/compute', { method: 'POST', body: body || {} }),
  ...
  getTransactions: () => API.req('/finance/transactions'),
  addTransaction: (body) => API.req('/finance/transactions', { method: 'POST', body }),
  addFinanceRecord: (body) => API.req('/finance/records', { method: 'POST', body }),
